...
void dr_setup_entry(struct route_t*, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, int, int);

void dr_add_entry(struct route_t*);

void dr_replace_entry(uint32_t);

void dr_ck_del_entry(uint32_t);

void dr_del_entry(uint32_t);

void dr_send_advert();

struct route_t* dr_search_subnet(struct route_t*, uint32_t);
